...
date: 2025-7-29
lien: "https://cvefeed.io/vuln/detail/CVE-2025-7809"
categories:
  - cve
---
...
Description : The StreamWeasels Twitch Integration plugin for WordPress is vulnerable to Stored Cross-Site Scripting via the plugin's 'data-uuid' attribute in all versions up to
and including
1.9.3 due to insufficient input sanitization and output escaping on user supplied attributes. This makes it possible for authenticated attackers
