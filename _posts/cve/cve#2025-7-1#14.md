...
CVE ID : CVE-2025-5314 Published : July 1
2025
12:15 p.m. | 19 hours
50 minutes ago Description : The Dear Flipbook – PDF Flipbook
3D Flipbook
PDF embed
...
and including
2.3.65 due to insufficient input sanitization and output escaping. This makes it possible for unauthenticated attackers to inject arbitrary web scripts in pages that execute if they can successfully trick a user into performing an action such as clicking on a link. Severity: 6.1 | MEDIUM Visit the link for more details
