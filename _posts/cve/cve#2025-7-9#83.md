...
date: 2025-7-9
lien: "https://cvefeed.io/vuln/detail/CVE-2025-6691"
categories:
  - cve
---
...
Description : The SureForms – Drag and Drop Form Builder for WordPress plugin for WordPress is vulnerable to arbitrary file deletion due to insufficient file path validation in the delete_entry_files() function in all versions up to
and including
1.7.3. This makes it possible for unauthenticated attackers to delete arbitrary files on the server
