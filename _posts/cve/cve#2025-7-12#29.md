...
CVE ID : CVE-2020-36847 Published : July 12
2025
10:15 a.m. | 9 hours
59 minutes ago Description : The Simple-File-List Plugin for WordPress is vulnerable to Remote Code Execution in versions up to
and including
4.2.2 via the rename function which can be used to rename uploaded PHP code with a png extension to use a php extension. This allows unauthenticated attackers to execute code on the server. Severity: 9.8 | CRITICAL Visit the link for more details
