...
date: 2025-7-9
lien: "https://cvefeed.io/vuln/detail/CVE-2025-6975"
categories:
  - cve
---
...
Description : The Events Manager – Calendar
Bookings
Tickets
and more! plugin for WordPress is vulnerable to Reflected Cross-Site Scripting via the ‘calendar_header’ parameter in all versions up to
and including
7.0.3 due to insufficient input sanitization and output escaping. This makes it possible for unauthenticated attackers to inject arbitrary web scripts in pages that execute if they can successfully trick a user into performing an action such as clicking on a link.
