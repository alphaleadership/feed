...
date: 2025-8-5
lien: "https://cvefeed.io/vuln/detail/CVE-2025-43978"
categories:
  - cve
---
...
Description : Jointelli 5G CPE 21H01 firmware JY_21H01_A3_v1.36 devices allow (blind) OS command injection. Multiple endpoints are vulnerable
including /ubus/?flag=set_WPS_pin and /ubus/?flag=netAppStar1 and /ubus/?flag=set_wifi_cfgs. This allows an authenticated attacker to execute arbitrary OS commands with root privileges via crafted inputs to the SSID
WPS
Traceroute
and Ping fields.
