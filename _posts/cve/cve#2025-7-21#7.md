...
date: 2025-7-21
lien: "https://cvefeed.io/vuln/detail/CVE-2025-53832"
categories:
  - cve
---

CVE ID : CVE-2025-53832 Published : July 21
2025
9:15 p.m. | 11 hours
41 minutes ago Description : Lara Translate MCP Server is a Model Context Protocol (MCP) Server for Lara Translate API. Versions 0.0.11 and below contain a command injection vulnerability which exists in the @translated/lara-mcp MCP Server. The vulnerability is caused by the unsanitized use of input parameters within a call to child_process.exec
...
>
&&
etc.). This vulnerability is fixed in version 0.0.12. Severity: 7.5 | HIGH Visit the link for more details
