...
Published :  Oct. 9
2025
2:15 a.m. | 28 minutes ago

Description : The WP Go Maps (formerly WP Google Maps) plugin for WordPress is vulnerable to Cross-Site Request Forgery (CSRF) in all versions up to
and including
...
and allows anonymous users to trigger mass deletion of markers via unsafe GET requests.
