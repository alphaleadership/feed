...
Description : Cursor is a code editor built for programming with AI. In versions 1.2.4 and below
...
the attacker can achieve arbitrary code execution. This is fixed in version 1.3.
