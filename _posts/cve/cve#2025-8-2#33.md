...
date: 2025-8-2
lien: "https://cvefeed.io/vuln/detail/CVE-2025-6626"
categories:
  - cve
---

CVE ID : CVE-2025-6626 Published : Aug. 2
2025
8:15 a.m. | 13 hours
21 minutes ago Description : The ShortPixel Adaptive Images – WebP
AVIF
CDN
Image Optimization plugin for WordPress is vulnerable to Stored Cross-Site Scripting via the API URL Setting in all versions up to
and including
3.10.3 due to insufficient input sanitization and output escaping. This makes it possible for authenticated attackers
with administrator-level access
to inject arbitrary web scripts in pages that will execute whenever a user accesses an injected page. This only affects multi-site installations and installations where unfiltered_html has been disabled. Severity: 4.4 | MEDIUM Visit the link for more details
