...
date: 2025-8-16
lien: "https://cvefeed.io/vuln/detail/CVE-2025-8105"
categories:
  - cve
---

CVE ID : CVE-2025-8105 Published : Aug. 16
2025
12:15 p.m. | 1 day
11 hours ago Description : The The Soledad theme for WordPress is vulnerable to arbitrary shortcode execution in all versions up to
and including
8.6.7. This is due to the software allowing users to execute an action that does not properly validate a value before running do_shortcode. This makes it possible for unauthenticated attackers to execute arbitrary shortcodes. Severity: 7.3 | HIGH Visit the link for more details
