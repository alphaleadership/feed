...
CVE ID : CVE-2025-7195 Published : Aug. 7
2025
7:15 p.m. | 5 hours
34 minutes ago Description : Early versions of Operator-SDK provided an insecure method to allow operator containers to run in environments that used a random UID. Operator-SDK before 0.15.2 provided a script
user_setup
...
including UID 0
leading to full root privileges within the container. Severity: 5.2 | MEDIUM Visit the link for more details
