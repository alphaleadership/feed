...
date: 2025-8-7
lien: "https://cvefeed.io/vuln/detail/CVE-2025-34151"
categories:
  - cve
---
...
Description : A command injection vulnerability exists in the 'passwd' parameter of the PPPoE setup process on the Shenzhen Aitemi M300 Wi-Fi Repeater (hardware model MT02). The input is passed directly to system-level commands without sanitation
enabling unauthenticated attackers to achieve root-level code execution.
