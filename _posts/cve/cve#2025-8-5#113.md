...
date: 2025-8-5
lien: "https://cvefeed.io/vuln/detail/CVE-2025-54135"
categories:
  - cve
---
...
Description : Cursor is a code editor built for programming with AI. Cursor allows writing in-workspace files with no user approval in versions below 1.3.9
If the file is a dotfile
editing it requires approval but creating a new one doesn't. Hence
if sensitive MCP files
such as the .cursor/mcp.json file don't already exist in the workspace
