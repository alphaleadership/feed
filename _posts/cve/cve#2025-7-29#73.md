...
date: 2025-7-29
lien: "https://cvefeed.io/vuln/detail/CVE-2025-8196"
categories:
  - cve
---
...
Description : The Magical Addons For Elementor plugin for WordPress is vulnerable to Stored Cross-Site Scripting via the plugin's Custom Attributes in all versions up to
and including
1.3.8 due to insufficient input sanitization and output escaping on user supplied attributes. This makes it possible for authenticated attackers
