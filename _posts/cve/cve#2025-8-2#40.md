...
CVE ID : CVE-2025-6078 Published : Aug. 2
2025
3:15 a.m. | 18 hours
21 minutes ago Description : Partner Software's Partner Software application and Partner Web application allows an authenticated user to add notes on the 'Notes' page when viewing a job but does not completely sanitize input
...
leading to stored XSS (cross-site scripting). Severity: 0.0 | NA Visit the link for more details
