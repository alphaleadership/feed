...
Description : File contents could be read from the local file system by an attacker. Additionally
malicious code could be inserted in the file
leading to a full compromise of the web application and the container it is running on.
