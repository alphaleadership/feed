...
CVE ID : CVE-2025-6720 Published : July 19
2025
6:15 a.m. | 10 hours
11 minutes ago Description : The Vchasno Kasa plugin for WordPress is vulnerable to unauthorized loss of data due to a missing capability check on the clear_all_log() function in all versions up to
and including
1.0.3. This makes it possible for unauthenticated attackers to clear log files. Severity: 5.3 | MEDIUM Visit the link for more details
