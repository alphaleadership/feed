...
CVE ID : CVE-2025-54782 Published : Aug. 2
2025
12:15 a.m. | 14 hours
9 minutes ago Description : Nest is a framework for building scalable Node.js server-side applications. In versions 0.2.0 and below
...
accepts JSON input containing a code field and executes the provided code in a Node.js vm.runInNewContext sandbox. This is fixed in version 0.2.1. Severity: 0.0 | NA Visit the link for more details
